...
ALTER TABLE [address_yard_] ADD FOREIGN KEY ([id_]) REFERENCES [yard_] ([id_address_])
GO

ALTER TABLE [address_yard_] ADD FOREIGN KEY ([id_]) REFERENCES [equipment_] ([id_address_])
GO

ALTER TABLE [rent_yard_] ADD FOREIGN KEY ([id_]) REFERENCES [payment_income_] ([id_rent_yard_])
GO

ALTER TABLE [equipment_] ADD FOREIGN KEY ([id_]) REFERENCES [repair_equipment_] ([id_equipment_])
GO
